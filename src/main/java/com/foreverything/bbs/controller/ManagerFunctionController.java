...
public class ManagerFunctionController {
    ...
    public String upArticle(@Param("id")Long id, HttpServletRequest request){
    ...
    public String upTopic(@Param("id")Long id,HttpServletRequest request){
    ...
    public String deleteArticle(@Param("id")Long id ,HttpServletRequest request){
    ...
    public String deleteTopic(long id,HttpServletRequest request){
    ...
    public String deleteReplay(long id,HttpServletRequest request){
    ...
    public String deleteReward(long id,HttpServletRequest request){
    ...
    public String cancelUpTopic(long id,HttpServletRequest request){
    ...
    public String cancelUpArticle(long id,HttpServletRequest request){
    ...
    public String marrowArticle(long id,HttpServletRequest request){
    ...
    public String marrowTopic(long id,HttpServletRequest request){
    ...
    public String cancelMarrowTopic(long id,HttpServletRequest request){
    ...
    public String cancelMarrowArtic(long id,HttpServletRequest request){
